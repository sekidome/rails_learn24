# -*- encoding: utf-8 -*-
# stub: ruby-lsp-rails 0.3.6 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<ruby-lsp>.freeze, [">= 0.16.5".freeze, "< 0.17.0".freeze])
  s.add_runtime_dependency(%q<sorbet-runtime>.freeze, [">= 0.5.9897".freeze])
end
